...
export const GlobalAlertsCenter = () => {
    ...
    const handleSelectAlert = (alert: AlertItem) => {
        ...
        // On mobile, we might want to scroll to detail, but for now stacking is sufficient
    };

    return (
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 pb-8 h-[calc(100vh-100px)] md:h-[calc(100vh-140px)] flex flex-col px-2 md:px-0">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 flex-1 min-h-0 overflow-y-auto lg:overflow-hidden">
                ...
                <div className="lg:col-span-4 flex flex-col gap-4 min-h-0 h-auto lg:h-full shrink-0">
                    <div className="shrink-0">
                        <SeverityOverview alerts={MOCK_ACTIVE_ALERTS} />
                    </div>
                    <div className="h-[400px] lg:flex-1 lg:min-h-0 lg:h-auto">
                        <ActiveAlertsList
                ...
                <div className="lg:col-span-8 flex flex-col gap-4 min-h-0 h-auto lg:h-full shrink-0">
                    <div className="lg:flex-1 lg:min-h-0 overflow-y-auto min-h-[500px] lg:min-h-0">
